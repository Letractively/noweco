...
public class MailboxConfigurationBeanFactoryPostProcessor implements BeanFactoryPostProcessor {
    ...
    public void postProcessBeanFactory(final ConfigurableListableBeanFactory beanFactory) throws BeansException {
        ...
        try {
            ...
            /*
             * PMD : J'ai rajouté cette partie afin que la mailbox webmail
             * puisse être reconnue. Il faut substituer cette classe dans :
             * /james-server-container-spring/src/main/java/org/apache/james/container
             * /spring/bean/factorypostprocessor/MailboxConfigurationBeanFactoryPostProcessor.java
             */
            else if (provider.equalsIgnoreCase("webmail")) {
                mailbox = "webmail-mailboxmanager";
                subscription = "webmail-subscriptionManager";
            }
            /*
             * FIN
             */
