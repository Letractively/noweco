...
public class WebmailMessageMapper implements MessageMapper<Integer> {
     ...
     * @param processor
     */
    public WebmailMessageMapper(WebmailProcessor processor) {
    ...
    /* (non-Javadoc)
     * @see org.apache.james.mailbox.store.mail.MessageMapper#findInMailbox(org.apache.james.mailbox.store.mail.model.Mailbox, org.apache.james.mailbox.MessageRange, org.apache.james.mailbox.store.transaction.Mapper.MailboxMembershipCallback)
     */
    public void findInMailbox(Mailbox<Integer> mailbox, MessageRange set, MailboxMembershipCallback<Integer> callback) throws MailboxException {
     ...
     */
    public List<Message<Integer>> findRecentMessagesInMailbox(Mailbox<Integer> mailbox) throws MailboxException {
     ...
     */
    public long add(Mailbox<Integer> mailbox, Message<Integer> message) throws MailboxException {
     ...
     */
    public long copy(Mailbox<Integer> mailbox, long uid, Message<Integer> original) throws MailboxException {
